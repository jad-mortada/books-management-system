...
@Entity
@Table(name = "lists", uniqueConstraints = { @UniqueConstraint(columnNames = { "class_id", "year" }) })
public class ListEntity {
	...
	public String toString() {
		return "ListEntity{" + "id=" + id + ", classEntity=" + (classEntity != null ? classEntity.getName() : "null")
				+ ", year=" + year + '}';
	}
}
