...
@Entity
@Table(name = "list_books", uniqueConstraints = {
...
public class ListBook {
    ...
    public ListBook(ListEntity listEntity, Book book, Integer quantity) {
    ...
    public String toString() {
        return "ListBook{" +
               "id=" + id +
               ", listEntityId=" + (listEntity != null ? listEntity.getId() : "null") +
