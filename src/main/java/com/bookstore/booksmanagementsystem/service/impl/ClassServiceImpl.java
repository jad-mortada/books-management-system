...
public class ClassServiceImpl implements ClassService {
    ...
    public ClassServiceImpl(ClassEntityRepository classEntityRepository, SchoolRepository schoolRepository, ModelMapper modelMapper) {
    ...
    public ClassDTO createClass(ClassDTO classDTO) {
        ...
        classEntityRepository.findByNameAndSchoolIdAndYear(classDTO.getName(), classDTO.getSchoolId(), classDTO.getYear())
                .ifPresent(c -> {
